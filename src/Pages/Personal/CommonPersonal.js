...
const CommonPortfilo = ({ condition, items }) => {
  ...
  const handleSearch = (text) => {
    handlePersonalData(text);
    setTest(text);
  };
  useEffect(() => {
    setTest("All");
    //handlePersonalData("All");
  }, []);
  const handleModle = (id) => {
    handlePersonalModelData(id);
  };
  ...
  return (
    <>
      <PageTitle title="Personal"></PageTitle>
      {/* End pagetitle */}
          ...
          <div className="container mb-8   px-4 sm:px-5 md:px-10 lg:px-[60px]">
            <div className="py-12">
              ...
              >
                ...
                <li
                  className={`${
                    test === "Portfolio" ? "text-[#FA5252]" : "fillter-btn"
                  } mr-4 md:mx-4`}
                  onClick={() => handleSearch("Portfolio")}
                >
                  Portfolio
                </li>
                <li
                  className={`${
                    test === "E-Commerce" ? "text-[#FA5252]" : "fillter-btn ml-0"
                  } mr-4 md:mx-4`}
            ...
            >
              {personaldata.slice(0, items).map((item) => (
                <div
                  style={{
                    background: `${
